...
export default function Preparatory() {
  const programs = [
    {
      title: "Math-Physique",
      description: "Formation en mathématiques et physique pour préparer les étudiants aux études d'ingénierie.",
    ...
    },
    {
      ...
      description: "Formation en physique et chimie pour préparer les étudiants aux études scientifiques.",
    ...
    {
      title: "Physique-Technologie",
      description: "Formation en physique et technologie pour préparer les étudiants aux études techniques.",
  ...
  return (
    <div className="container mx-auto py-12">
      <FadeIn>
        <h1 className="text-4xl font-bold mb-8 text-[#0B2C67] dark:text-white">Preparatory Cycle</h1>
      </FadeIn>
      <FadeIn delay={0.2}>
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-12">
          L’IPSAS propose un cycle préparatoire de deux ans pour préparer les étudiants aux études d'ingénierie.
        </p>
      </FadeIn>
