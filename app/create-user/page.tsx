...
export default function CreateUser() {
  ...
  const [birthdate, setBirthdate] = useState<Date | null>(null); // Track the selected birthdate
      ...
      <CardContent>
        <form className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <DatePickerWithYear
              selected={birthdate} // Pass the selected date here
              onChange={(date) => setBirthdate(date)} // Update the birthdate state when the date changes
            />
          </div>
